...
//                }
  ...
  //  return (responseValue, nil)
    ...
    //fxbooking address List
        func gethomeaddressList(headersTobePassed : HTTPHeaders,postParameters :[String:Any],completionHandler: @escaping (NSDictionary?, String?) -> ())
        {
            
            let apiUlr = CanvasUrls.baseUrl +  CanvasUrls.versionNumber + CanvasUrls.getfxbookinaddress
