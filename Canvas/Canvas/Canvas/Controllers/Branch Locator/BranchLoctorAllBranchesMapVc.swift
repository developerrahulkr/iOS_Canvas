//
//  BranchLoctorAllBranchesMapVc.swift
//  Canvas
//
...
class BranchLoctorAllBranchesMapVc: UIViewController, GMSMapViewDelegate {
    ...
    // Mark: For downloading branches data
    ...
    // Mark: When marker selected for directions and maps
