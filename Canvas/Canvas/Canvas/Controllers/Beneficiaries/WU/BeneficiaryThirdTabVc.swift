...
class BeneficiaryThirdTabVc: BaseViewController, UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout  {
    ...
    //   self.showSpinner(onView: self.view)
     ...
     //   downloadBeneficiary()
        ...
        self.beneficaryFilteredResponse =  BeneficiaryDetails.shared.beneficaryWuFilteredResponse
  ...
  //  downloadBeneficiary()
    ...
    if Global.shared.refreshOrNot == "Wu" {
        downloadBeneficiary()
...
//                                self.present(refreshAlert, animated: true, completion: nil)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = beneficiaryTbleView.dequeueReusableCell(withIdentifier: "BeneficiaryThirdTabCell")! as! BeneficiaryThirdTabCell
     ...
     //   cell.bankNameLbl.text = eachObj?.value(forKey: "bankName") as? String ?? ""
        let benefName = eachObj?.value(forKey: "bankName") as? String ?? ""
        let currencyN = eachObj?.value(forKey: "currency") as? String ?? ""
        cell.bankNameLbl.text = benefName + "/" + currencyN
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        Global.shared.benefCasBankWu = "WU"
        let eachObj = self.beneficaryFilteredResponse[indexPath.row] as?NSDictionary
    ...
    @IBAction func editBtnActn(_ sender: Any) {
        self.pushViewController(controller: BenefWuEditVc.initiateController(),animated: true)
        ...
        
    {
        ...
        /*  self.pushViewController(controller: BenefWuEditVc.initiateController(),animated: true)
            ...
            let vc = self.storyboard?.instantiateViewController(identifier: "BenefWuEditVc") as! BenefWuEditVc
...
//                                        self.present(refreshAlert, animated: true, completion: nil)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = benefCollectnView.dequeueReusableCell(withReuseIdentifier: "BenefThirdTabCollectnCell", for: indexPath) as! BenefThirdTabCollectnCell
     ...
     //   cell.nameLbl.text = eachObj?.value(forKey: "firstName") as? String ?? ""
        ...
        cell.bankLbl.text = eachObj?.value(forKey: "beneficiaryTypeName") as? String ?? ""
    //    cell.bankLbl.text = eachObj?.value(forKey: "currency") as? String ?? ""
...
//                                                             self.present(refreshAlert, animated: true, completion: nil)
    ...
    @IBAction func directTrnsfrActn(_ sender: Any) {
      self.pushViewController(controller: BenefWuDirectTransferVc.initiateController(),animated: true)
    }
