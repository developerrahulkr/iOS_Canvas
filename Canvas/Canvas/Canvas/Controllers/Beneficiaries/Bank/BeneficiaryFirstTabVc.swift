...
class BeneficiaryFirstTabVc: BaseViewController, UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    
    
    
    @IBOutlet weak var testLabel: UILabel!
    
    @IBOutlet weak var bankTrnsfrTableView: UITableView!
    ...
    override func viewDidLoad() {
     ...
     //    downloadBeneficiary()
        self.beneficaryFilteredResponse =  BeneficiaryDetails.shared.beneficaryBankFilteredResponse
        
        self.bankTrnsfrTableView.reloadData()
        ...
        if UserDefaults.exists(key: "enableListView") {
            if UserDefaults.standard.string(forKey: "enableListView")! == "list" {
                ...
                testLabel.text = "list"
                bankTrnsfrTableView.isHidden = false
                benefCollectnView.isHidden = true
            }
            else {
                testLabel.text = "grid"
               
                bankTrnsfrTableView.isHidden = true
...
//        downloadBeneficiary()
    ...
    override func viewWillAppear(_ animated: Bool) {
      ...
      //  self.beneficaryFilteredResponse.removeAll()
      //  self.beneficiaryResponse.removeAll()
        if Global.shared.refreshOrNot == "Bank" {
            downloadBeneficiary()
...
//                                        self.present(refreshAlert, animated: true, completion: nil)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = benefCollectnView.dequeueReusableCell(withReuseIdentifier: "BenefFirstTabCollectnCell", for: indexPath) as! BenefFirstTabCollectnCell
