...
class BenefBankEditVc: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate,UINavigationControllerDelegate, UIPopoverControllerDelegate, UIDropDownCountryDelegateM {
    
    
    @IBOutlet weak var profileDetailsLbl: UILabel!
    ...
    override func viewDidLoad() {
        ...
        profileDetailsLbl.text = Global.shared.profileDetlsTxt
        ...
        acntNumberField.text = BeneficiaryDetails.shared.accountNumber
        bankNameField.text = BeneficiaryDetails.shared.bankName
        branchNameField.text =  BeneficiaryDetails.shared.branchName
        ifscCodeField.text = BeneficiaryDetails.shared.ifscCode
        swiftCodeField.text =  BeneficiaryDetails.shared.swiftCode
        ibanCodeField.text = BeneficiaryDetails.shared.ibanCode
        cnicnoField.text =  BeneficiaryDetails.shared.cnicno
        ...
        /*     firstField.isUserInteractionEnabled = false
         ...
         acntNumberField.isUserInteractionEnabled = false
        ...
        /*  firstView.backgroundColor = ColorCodes.FREEZEGRAY
         ...
         bkOneView.backgroundColor = ColorCodes.FREEZEGRAY
         ...
         branchCodeView.backgroundColor = ColorCodes.FREEZEGRAY*/
    ...
    func generateOTP() {
        ...
        NetWorkDataManager.sharedInstance.benefGenerateOtpImplimentation(headersTobePassed: headers, postParameters: paramaterPasing) { resonseTal , errorString in
            ...
            if errorString == nil
            {
                ...
                Global.shared.fromNewExistUser = "Benef1Edit"
...
//                                self.present(refreshAlert, animated: true, completion: nil)
    ...
    func submitBankTransfer() {
        ...
        let paramaterPasing: [String:Any] = ["registrationId": Global.shared.afterLoginRegistrtnId ?? "",
                                             ...
                                             "address1": self.adres1Field.text ?? "",
                                             "address2": self.adres2Field.text ?? "",
        ]
...
/*    override func viewWillLayoutSubviews() {
    ...
    func updateProfileImage() {
        ...
        NetWorkDataManager.sharedInstance.benefImgImplimentation(headersTobePassed: headers, postParameters: paramaterPasing) { resonseTal , errorString in
            ...
            if errorString == nil
            {
                ...
                print(resonseTal!)
                Global.shared.refreshOrNot = "Bank"
                let statusMsg = resonseTal?.value(forKey: "statusMessage") as? String ?? ""
            let mesageCode = resonseTal?.value(forKey: "messageCode") as? String ?? statusMsg
    ...
    @IBAction func curencyDrpActn(_ sender: Any) {
