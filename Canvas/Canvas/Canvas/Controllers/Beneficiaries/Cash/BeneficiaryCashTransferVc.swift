//
//  BeneficiaryCashTransferVc.swift
//  Canvas
//
...
class BeneficiaryCashTransferVc: UIViewController, UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIPopoverControllerDelegate, UIDropDownCountryDelegateM, UIPopoverControllerDelegateM {
   ...
   @IBOutlet weak var submitBtnOtlt: UIButton!
    ...
    func assigingLabels() {
     ...
     //   branchCodeField.maxLength = BeneficiaryDetails.shared.cash_District_max_length
     ...
     /*   let headers: HTTPHeaders = [
        ...
        NetWorkDataManager.sharedInstance.benefGenerateOtpImplimentation(headersTobePassed: headers, postParameters: paramaterPasing) { resonseTal , errorString in
            ...
            if errorString == nil
            {
                ...
                Global.shared.fromNewExistUser = "Benef2"
...
//                                self.present(refreshAlert, animated: true, completion: nil)
    ...
    @IBAction func curencyDrpBtnActn(_ sender: Any) {
