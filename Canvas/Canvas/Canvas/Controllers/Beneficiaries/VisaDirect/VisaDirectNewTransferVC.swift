//
//  VisaDirectNewTransferVC.swift
//  Canvas
//
//  Created by Sandeep on 18/05/22.
...
class VisaDirectNewTransferVC: BaseViewController, UITextFieldDelegate {
...
//    @IBOutlet weak var branchValue: UILabel!
    ...
    override func viewDidLoad() {
        ...
        navHeaderLbl.text = Global.shared.VisaDirect
...
//        currencyLbl.text = Global.shared.currencyb ?? ""
 ...
 //       acntLbl.text = Global.shared.benefListDetailsAcno
        cardNumLbl.text = Global.shared.VisaCardNumber
      ...
      //  bankValue.text = BeneficiaryDetails.shared.bankName
        countryValue.text = BeneficiaryDetails.shared.countryName
        currencyValue.text = BeneficiaryDetails.shared.currency
       // curencyValueLbl.text = BeneficiaryDetails.shared.currency
        cardValue.text = BeneficiaryDetails.shared.cardNumber
   ...
   func getSessionToken()
    {
        ...
        NetWorkDataManager.sharedInstance.getSessionIdImplimentation(headersTobePassed: headers, postParameters: paramaterPasing) { resonseTal , errorString in
            ...
            {
                print(resonseTal)
                if let sessionID = resonseTal?.value(forKey: "sessionID") as? String
                {
             ...
             print(resonseTal)
                if let benList = resonseTal?.value(forKey: "beneficiariesResponseList") as? NSArray {
                 ...
                 //   self.targetImg.image = UIImage(named: BeneficiaryDetails.shared.countryName)
                    ...
                    BeneficiaryDetails.shared.cardNumber = (benList[0] as AnyObject).value(forKey: "cardNumber") as? String ?? ""
...
extension VisaDirectNewTransferVC: PopupViewControllerDelegate {
