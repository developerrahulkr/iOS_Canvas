...
class BeneficiaryFourthTabVc: BaseViewController, UITableViewDataSource, UITableViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    
    @IBOutlet weak var testLabel: UILabel!
    
    @IBOutlet weak var visaTableView: UITableView!
    ...
    override func viewDidLoad() {
     ...
     //    downloadBeneficiary()
        self.beneficaryFilteredResponse =  BeneficiaryDetails.shared.beneficaryVisaFilteredResponse
        
        self.visaTableView.reloadData()
        ...
        if UserDefaults.exists(key: "enableListView") {
            if UserDefaults.standard.string(forKey: "enableListView")! == "list" {
                ...
                testLabel.text = "list"
                visaTableView.isHidden = false
                benefCollectnView.isHidden = true
            }
            else {
                testLabel.text = "grid"
               
                visaTableView.isHidden = true
...
//        downloadBeneficiary()
    ...
    override func viewWillAppear(_ animated: Bool) {
      ...
      //  self.beneficaryFilteredResponse.removeAll()
      //  self.beneficiaryResponse.removeAll()
        if Global.shared.refreshOrNot == "Visa" {
            downloadBeneficiary()
           // BeneficiaryDetails.shared.refreshOrNot = "no"
        }
        else {
            print("don't refresh")
        }
...
//                                self.present(refreshAlert, animated: true, completion: nil)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = visaTableView.dequeueReusableCell(withIdentifier: "beneficiaryFourthTabCell")! as! beneficiaryFourthTabCell
        ...
        if let isFavourite =  eachObj?.value(forKey: "isFavourite") as? Bool {
            ...
            //  cell.starBtnOtlt.setImage(, for: .normal)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        Global.shared.benefCasBankWu = "Visa"
        let eachObj = self.beneficaryFilteredResponse[indexPath.row] as?NSDictionary
       ...
       // BeneficiaryDetails.shared.beneficiaryType = 103
        ...
        let disablee = eachObj?.value(forKey: "isDisable") as? Bool ?? false
              ...
              if disablee == false {
                self.pushViewController(controller: VisaDirectNewTransferVC.initiateController())
              }
              else {
  ...
  //      let vc = self.storyboard?.instantiateViewController(identifier: "BenefBankCashNewTransferVc") as! BenefBankCashNewTransferVc
   //     self.navigationController?.pushViewController(vc, animated: true)
    ...
    /*  func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
     ...
     let cell = bankTrnsfrTableView.dequeueReusableCell(withIdentifier: "BeneficiaryFirstTabCell")! as! BeneficiaryFirstTabCell
     let eachObj = self.beneficaryFilteredResponse[indexPath.row] as?NSDictionary
    ...
    {
        let cell = visaTableView.dequeueReusableCell(withIdentifier: "BeneficiaryFirstTabCell")! as! BeneficiaryFirstTabCell
        let eachObj = self.beneficaryFilteredResponse[indexPath.row] as?NSDictionary
        
        cell.beneficiaryId = eachObj?.value(forKey: "beneficiaryId") as? Int ?? 0
        
        // Write action code for the edit
...
//                                        self.present(refreshAlert, animated: true, completion: nil)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = benefCollectnView.dequeueReusableCell(withReuseIdentifier: "BeneficaryFourTabCollectnCell", for: indexPath) as! BeneficaryFourTabCollectnCell
        print(self.beneficaryFilteredResponse.count)
        if self.beneficaryFilteredResponse.count == 0
        {
        ...
        let firstNameTxt  = eachObj?.value(forKey: "firstName") as? String ?? ""
           ...
           let acntNumbr = eachObj?.value(forKey: "cardNumber") as? String ?? ""
           let curencyTxt = eachObj?.value(forKey: "currency") as? String ?? ""
    ...
    //    cell.nameLbl.text = eachObj?.value(forKey: "firstName") as? String ?? ""
      ...
      //  cell.currencyLbl.text = eachObj?.value(forKey: "currency") as? String ?? ""
        ...
        cell.editBtnOtlt.params["cardNumber"] = eachObj?.value(forKey: "cardNumber") as? String ?? ""
        cell.editBtnOtlt.params["sendToOwnCard"] = eachObj?.value(forKey: "sendToOwnCard") as? String ?? ""
