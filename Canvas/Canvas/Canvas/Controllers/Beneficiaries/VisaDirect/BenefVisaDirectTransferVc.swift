//
//  BenefVisaDirectTransferVc.swift
//  Canvas
//
//  Created by Sandeep on 11/05/22.
//  Copyright © 2022 urmila reddy. All rights reserved.
//

import UIKit
import Alamofire
class BenefVisaDirectTransferVc: UIViewController,UITextFieldDelegate, UIPopoverControllerDelegateM,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UIPopoverControllerDelegate, UIDropDownCountryDelegateM {
    
    @IBOutlet weak var sendOwnRequireLbl: UILabel!
...
//    @IBOutlet weak var branchCodeReqLbl: UILabel!
    ...
    override func viewDidLoad() {
      ...
      sendOwnRequireLbl.font = Global.shared.fontReqLbl
      sendOwnRequireLbl.textColor = ColorCodes.newAppRed
...
//        }
      /*  if BeneficiaryDetails.shared.bank_BranchCode_is_required == true {
        ...
        sendOwnRequireLbl.text =  Global.shared.VisaSendToOwnCard + " " + Global.shared.errorTxtRequired.lowercased()
        
        bankNameReqLbl.text =  Global.shared.VisaCardNumber + " " + Global.shared.errorTxtRequired.lowercased()
        
      //  sendOwnRequireLbl.text =  Global.shared.branchNameb + " " + Global.shared.errorTxtRequired.lowercased()
...
//        branchCodeReqLbl.text = Global.shared.branchCodeb + " " +  Global.shared.errorTxtRequired.lowercased()
      ...
      //  acntNumberField.maxLength = BeneficiaryDetails.shared.bank_AccountNumber_max_length
        bankNameField.maxLength = BeneficiaryDetails.shared.visa_CardNumber_max_length
       // bankNameField.minLegth = BeneficiaryDetails.shared.visa_CardNumber_min_length
...
//        remarksField.maxLength = BeneficiaryDetails.shared.bank_Remarks_max_length
      ...
      //  acntNumberField.valueType = Global.shared.getFieldType(text: BeneficiaryDetails.shared.bank_AccountNumber_field_accept)
        bankNameField.valueType = Global.shared.getFieldType(text: BeneficiaryDetails.shared.visa_CardNumber_field_accept)
...
//        remarksField.keyboardType = UIKeyboardType.asciiCapable
    ...
    @IBAction func submitBtnActn(_ sender: Any) {
        ...
        else  if BeneficiaryDetails.shared.visa_CardNumber_is_required == true && bankNameField.text == "" {
            bankNameReqLbl.isHidden = false
            bankNameField.becomeFirstResponder()
            self.removeSpinner()
        }
        else  if BeneficiaryDetails.shared.visa_SentToOwnCard_is_required == true && txt_sendToOwn.text == "" {
            sendOwnRequireLbl.isHidden = false
     ...
     /*   let headers: HTTPHeaders = [
        ...
        NetWorkDataManager.sharedInstance.benefGenerateOtpImplimentation(headersTobePassed: headers, postParameters: paramaterPasing) { resonseTal , errorString in
            ...
            if errorString == nil
            {
                ...
                VisaDirect.shared.cardNum =  self.bankNameField.text ?? ""
                VisaDirect.shared.benefSendToOwn = self.txt_sendToOwn.text ?? ""
...
//                                self.present(refreshAlert, animated: true, completion: nil)
    ...
    func textFieldDidEndEditing(_ textField: UITextField) {
        ...
        if textField == firstField{
          ...
          /*  else  if textField == remarksField {
            ...
            if BeneficiaryDetails.shared.visa_CardNumber_is_required == true {
                ...
                else if bankNameField.text!.count < 10 {
                    bankNameReqLbl.text = "Minimum length of card number should be 10 digit."
                    bankNameReqLbl.isHidden = false
                }
                else {
                    bankNameReqLbl.text =  Global.shared.VisaCardNumber + " " + Global.shared.errorTxtRequired.lowercased()
        ...
        else  if textField == txt_sendToOwn {
            if BeneficiaryDetails.shared.visa_SentToOwnCard_is_required == true {
                if txt_sendToOwn.text!.count ==  0 {
                    sendOwnRequireLbl.isHidden = false
                }
                else {
                    sendOwnRequireLbl.isHidden = true
                }
            }
        }
    ...
    func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
       // textField.keyboardType = .asciiCapable
        ...
        if textField == firstField {
            ...
            return txt_sendToOwn.verifyFields(shouldChangeCharactersIn: range, replacementString: string)
        }
//        else  if textField == ifscCodeField {
//            if BeneficiaryDetails.shared.bank_IFSCCode_is_required == true {
    ...
    @IBAction func OnClickSendToOwnBtn(_ sender: Any) {
        ...
        let pickerData = BeneficiaryDetails.shared.pickervisaSendToOwnTypesData
               PickerDialog().show(title: "", options: pickerData , selected: "") {
                   ...
                   self.sendOwnRequireLbl.isHidden = true
