...
class RateCalculatorBankVc: UIViewController, UITextFieldDelegate, UIDropDownCurrencyDelegateM {
    ...
    override func viewDidLoad() {
        ...
        if Global.shared.indicativeRatesTxt != ""
        {
    ...
    // Mark: Calculating the rate accordingly
    func rateCalculator() {
