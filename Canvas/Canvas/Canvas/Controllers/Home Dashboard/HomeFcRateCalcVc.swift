...
class HomeFcRateCalcVc: UIViewController, UITextFieldDelegate, UIDropDownCurrencyDelegateM  {
    ...
    // Mark: Calculating rate when entered on source field
    func rateCalculator() {
    ...
    // Mark: Calculating rate when entred on target field
