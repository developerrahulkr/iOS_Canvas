...
class MenuViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UIGestureRecognizerDelegate {
 ...
 //   let menuImages=["india","india","india","india","india","india","india","india","india"]
    ...
    let menuNames=[Global.shared.menuDashboard, Global.shared.menuBeneficiary,Global.shared.menuTransactions, Global.shared.menuContact, Global.shared.loginChat, Global.shared.rateCalculatorHeader, Global.shared.ourBranches, Global.shared.faqTxt, Global.shared.menuRateThisAppString]
    let menuImages=["dashboardTab","beneficiariesTab","transactionsMenu","ContactUsMenu","chatMenu","rate-calculatorMenu","ourBranchesMenu","faqsMenu", "rateTheApp"]
