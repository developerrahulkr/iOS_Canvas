...
class HomeWuRateCalcVc: UIViewController, UITextFieldDelegate {
        ...
        @IBAction func targetCurencyBtnActn(_ sender: Any) {
         /*   let pickerData = Global.shared.pickerResponseFullCurrencyNameData
                       PickerDialog().show(title: "", options: pickerData , selected: "") {
                        ...
                        self.targetCountryCode = Global.shared.countryCodesData[indexS ?? 0]
 ...
 /*   func textFieldDidEndEditing(_ textField: UITextField) {
    ...
    // Mark: calculating wu rate when entered in target field
    ...
    extension HomeWuRateCalcVc: UIDropDownCurrencyDelegateM {
