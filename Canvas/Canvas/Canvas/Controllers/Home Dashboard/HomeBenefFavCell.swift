//
//  HomeBenefFavCell.swift
//  Canvas
//
//  Created by urmila reddy on 21/10/20.
...
class HomeBenefFavCell: UITableViewCell {
  ...
  /*  if self.starBtnOtlt.currentImage == UIImage(systemName: "star") {
               self.starBtnOtlt.setImage(UIImage(systemName: "star.fill"), for: .normal)
               self.starBtnOtlt.tintColor = .red
               isFav = true
               changeToFavourite()
           }
           else {
               self.starBtnOtlt.setImage(UIImage(systemName: "star"), for: .normal)
